...
class AnimalsControllerTest < ActionController::TestCase
  ...
  test "should create animal" do
    assert_difference('Animal.count') do
      post :create, animal: { description: @animal.description, image: @animal.image, name: @animal.name }
    end
  ...
  test "should update animal" do
    patch :update, id: @animal, animal: { description: @animal.description, image: @animal.image, name: @animal.name }
    assert_redirected_to animal_path(assigns(:animal))
  end
